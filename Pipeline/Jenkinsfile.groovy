pipeline {
  ...
  parameters {
    ...
    choice(name: "StartType", choices: ["None","Enabled","Disabled","Manual","Automatic","AutomaticDelayedStart"], description: "Enabled mode - for system Linux (not supported wildcard format). Automatic/Manual mode - for system Windows. Delayed Start mode - supported only PowerShell 7")
  }
  stages {
