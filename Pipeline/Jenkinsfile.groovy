pipeline {
  ...
  parameters {
    ...
    choice(name: "StartType", choices: ["None","Enable","Disabled","Manual","Automatic","AutomaticDelayedStart"], description: "Enable mode for Linux /nDelayed Start mode supported only PowerShell 7")
  }
  stages {
