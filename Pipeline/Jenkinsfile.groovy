pipeline {
  agent any
  parameters {
    string(name: "ServiceName", defaultValue: "ssh", trim: true, description: "Enter a service name. For Windows systems the default is Fildcard format. For Linux use formate *name*.")
