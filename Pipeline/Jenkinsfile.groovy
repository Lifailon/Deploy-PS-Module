pipeline {
  ...
  parameters {
    ...
    choice(name: "StartType", choices: ["None","Enable","Disabled","Manual","Automatic","AutomaticDelayedStart"], description: "Enable mode - for system Linux. Automatic/Manual mode - for system Windows. Delayed Start mode - supported only PowerShell 7")
  }
  stages {
